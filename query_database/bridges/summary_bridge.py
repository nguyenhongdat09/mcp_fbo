"""Orchestration bridge connecting query_database connection/catalog with sql_object_summary."""
...
from query_database.query_resolver import sanitize_sql_identifier
