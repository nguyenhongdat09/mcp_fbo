# Generated from e:/PythonProject/mcp_fbo/js_engine/tools/../grammar/JavaScriptParser.g4 by ANTLR 4.13.2
from antlr4 import *
if "." in __name__:
...
class JavaScriptParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavaScriptParser#singleVariableDeclaration.
    def visitSingleVariableDeclaration(self, ctx:JavaScriptParser.SingleVariableDeclarationContext):
        return self.visitChildren(ctx)
    ...
    def visitNamedFunction(self, ctx:JavaScriptParser.NamedFunctionContext):
        return self.visitChildren(ctx)
