...
-- clone_things type=1: dbo.FastBusiness$Balance$BContract | SQL_STORED_PROCEDURE | paste-for-edit | from source
ALTER PROCEDURE [dbo].[FastBusiness$Balance$BContract]
	@Date SMALLDATETIME, 
	@Unit VARCHAR(1023),
	@Account VARCHAR(33),
...
-- clone_things type=1: dbo.FastBusiness$System$UpdateOrderField | SQL_STORED_PROCEDURE | paste-for-edit | from source
ALTER PROCEDURE [dbo].[FastBusiness$System$UpdateOrderField]
...
-- clone_things type=1: dbo.cdku | USER_TABLE | paste-for-edit | from source
CREATE TABLE cdku(
...
-- clone_things type=1: dbo.dmdvcs | USER_TABLE | paste-for-edit | from source
CREATE TABLE dmdvcs(
	[ma_dvcs] char(8) NOT NULL,
...
-- clone_things type=1: dbo.dmku | USER_TABLE | paste-for-edit | from source
CREATE TABLE dmku(
	[ma_ku] char(16) NOT NULL,
...
-- clone_things type=1: dbo.r00$000000 | USER_TABLE | paste-for-edit | from source
...
-- clone_things type=1: dbo.reports | USER_TABLE | paste-for-edit | from source
...
-- clone_things type=1: dbo.zcdmcnql | USER_TABLE | paste-for-edit | from source
