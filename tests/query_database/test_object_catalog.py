"""Unit tests for query_database.object_catalog with mock executor matching real return structure."""

from unittest.mock import patch
from query_database.object_catalog.fetcher import ObjectCatalogFetcher, _rows_from_result
...
def test_object_catalog_fetch_one_mock():
    ...
    with patch("query_database.object_catalog.fetcher.execute_query") as mock_exec:
