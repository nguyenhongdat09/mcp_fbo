"""Unit tests for query_database.bridges.summary_bridge with mock fetcher."""

from unittest.mock import MagicMock
from query_database.bridges.summary_bridge import summary_object, resolve_object_ref, map_object_type
