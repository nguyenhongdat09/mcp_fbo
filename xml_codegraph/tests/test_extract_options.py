...
from xml_codegraph.builder.graph_builder import GraphBuilder
...
"""
        ...
        from xml_codegraph.utils import path_helper
...
"""
        ...
        self.assertGreater(len(entity_edges0), 0)
        ...
        self.assertGreater(len(shared_edges1), 0)
