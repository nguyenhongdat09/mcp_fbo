...
from xml_codegraph.storage.kuzu_index import KuzuIndexStore, close_cached_database
from xml_codegraph.builder.graph_builder import GraphBuilder, incremental_update_file, delete_node_by_path, generate_node_id
from xml_codegraph.core.schema import GraphNode, GraphEdge
from xml_codegraph.rules.edges_rules import EdgeType
from xml_codegraph.service.watcher import GraphUpdateHandler, invalidate_project_cache
...
class TestWatcherAdvanced(unittest.TestCase):
    ...
    def query_rows(self, cypher_query: str, params: dict = None) -> list:
        from xml_codegraph.query.engine import ensure_fresh_readonly_store
    ...
    def test_t7_ro_then_incremental_then_ro(self):
        ...
        from xml_codegraph.service.watcher import run_incremental_write
        import time
